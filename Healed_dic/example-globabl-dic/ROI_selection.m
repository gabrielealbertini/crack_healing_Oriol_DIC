...
[top,bot,global_roi,info] = compute_dic_clip_position(P);
...
save(save_file,'P','global_roi','top','bot','info')
%save([wdir,'global/roi.mat'],'global_roi')
%save([wdir,'COD/top/roi.mat'],'top')
%save([wdir,'COD/bot/roi.mat'],'bot')

function [top,bot,global_roi,info] = compute_dic_clip_position(P)
